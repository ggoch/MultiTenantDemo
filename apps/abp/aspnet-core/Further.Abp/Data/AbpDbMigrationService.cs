...
public class AbpDbMigrationService : ITransientDependency
{
    ...
    private readonly AbpEFCoreDbSchemaMigrator _dbSchemaMigrator;
    private readonly ITenantRepository _tenantRepository;
    private readonly ICurrentTenant _currentTenant;

    public AbpDbMigrationService(
        IDataSeeder dataSeeder,
        AbpEFCoreDbSchemaMigrator dbSchemaMigrator,
    ...
    private string GetEntityFrameworkCoreProjectFolderPath()
    {
        ...
        return Path.Combine(slnDirectoryPath, "Further.Abp");
    }
